...
import { updateAgencyAction } from "@/actions/agencyActions";
import { agencySchema } from "@/lib/validations/agency";
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select";

type AgencyFormValues = z.infer<typeof agencySchema>;

export function EditAgencyForm({ agency, managers }: { agency: any, managers: any[] }) {
  ...
  const { register, handleSubmit, setValue, formState: { errors } } = useForm<AgencyFormValues>({
    ...
    defaultValues: {
      nom: agency.nom,
      ville: agency.ville,
      adresse: agency.adresse || undefined,
      telephone: agency.telephone || undefined,
      responsable: agency.responsable || undefined,
    }
  });
  ...
  return (
    <div className="space-y-6 pb-20 md:pb-0 max-w-2xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Modifier l'Agence</h1>
          <p className="text-sm text-muted-foreground mt-1">Mettez à jour les informations de l'agence.</p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select defaultValue={agency.responsable || undefined} onValueChange={(value) => value && setValue('responsable', value as string)}>
